...
const Footer = () => {
  const socialLink = [
    {
      link: "https://www.instagram.com/valorantid",
      logo: <InstagramLogo size={20} />,
    },
    {
      link: "https://www.youtube.com/@valorant",
      logo: <YoutubeLogo weight="fill" size={20} />,
    },
    {
      link: "https://www.facebook.com/VALORANTid/",
      logo: <FacebookLogo weight="fill" size={20} />,
    },
  ];
    ...
    <div className="w-full bg-color-secondary text-color-white flex flex-col items-center py-8 pb-28 lg:pb-10 gap-12 lg:gap-8">
      ...
      <p className="text-xs px-8 lg:px-0 md:w-1/2 lg:w-1/3 text-center font-[100]">
        ...
        <Link
          ...
          className="hover:text-color-primary text-color-lighterSecondary"
          target="_blank"
        >
