...
export default function Home() {
  ...
  return (
    <div className="h-[200vh] overflow-x-hidden">
      <header
        className="h-[85vh] w-full bg-color-secondary relative flex items-center px-40 bg-left-bottom bg-cover"
        style={{
          backgroundImage:
      ...
      >
        <div className="w-1/2">
          <p className="font-bold text-color-white text-xl mb-4 ">
            Game tembak-menembak taktis berbasis karakter 5v5
          </p>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 690 98.9"
            className="fill-color-white w-full"
          >
